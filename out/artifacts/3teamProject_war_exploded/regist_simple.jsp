                ...
                <div class="page-body">
                    ...
                    <form name="ipinInForm" method="post">
                        <div class="box-wrap">
                            <ul class="join-form">
                                ...
                                <li><label>비밀번호</label>
                                    <input type="password" name="password1" id="password1"
                                           class="MS_input_txt w137 txt-input input-label" value="" size="15"
                                           maxlength="20" onkeyup="check_pwd_length(this, 'password');"/></li>
                                <li><label>비밀번호 확인</label>
                                    <input type="password" name="password2" id="password2"
                                           class="MS_input_txt w137 txt-input input-label" value="" size="15"
                                           maxlength="20" onkeyup="check_pwd_length(this, 'repassword');"/></li>
                                <li><label>이메일</label>
                                ...
                                <li><label>생년월일(ex.20001010)</label>
                                    <input type="text" name="birth" id="birth"
                                           class="MS_input_birth MS_input_txt06 w137 txt-input input-label" value=""
                                           size="15" maxlength="8"/></li>
                                <li><label>휴대폰번호</label>
                                    <input type="tel" name="etcphone" form="join_form" id="etcphone"
                            ...
                            <div class="appendMarketing">
                                <div class="marketing pb-10">
                                    <div class="mk-wrap" id="checkbox_group">
                                        <label class="mk-all"><input type="checkbox" name="ad_every_agree"
                                                                     id="ad_every_agree" value="ad_all"
                                                                     class="input-cbox every_agree new_every_agree"
                                                                     onclick="checkAll()"/> <strong>마케팅
                                            수신동의</strong></label>&nbsp;
                                        ( <label><input type="checkbox" name="ADemail_" id="ADemail_" value="ADemail_"
                                                        class="input-cbox every_agree ad_every_agree"/> 이메일</label>
                                        <label class="pl-30"><input type="checkbox" name="ADsms_" id="ADsms_"
                                                                    value="ADsms_"
                                                                    class="input-cbox every_agree ad_every_agree"/> SMS</label>
                                        <label class="pl-30"><input type="checkbox" name="ADpush_" id="ADpush_"
                                                                    value="ADpush_"
                            ...
                            <fieldset>
                                ...
                                <div class="new-privercy-contract">
                                    ...
                                    <div class="btn-area">
                                        <a href="javascript:send();" class="CSSbuttonBlackB">동의하고 가입하기</a>
                                        <!--<a href="Javascript:history.back()" class="CSSbuttonB">취소</a>-->
                                    </div>
                                    <div class="privercyBtns">
                                        본인은 <strong>만 14세 이상</strong>이며, <a href="#none" flag="chk_cont1">저스트원 이용약관,</a>
                                        <a href="#none" flag="chk_cont2">개인정보 수집 및 이용안내,</a> <a href="#none"
                                                                                                flag="chk_cont4">개인정보
                                        처리위탁</a>을<br/> 확인 화였으며, <strong>동의합니다.</strong>
                                    </div>
